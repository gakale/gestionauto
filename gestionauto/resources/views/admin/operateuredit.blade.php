...
<div class="col-md-12"><div class="box box-info">
    ...
    <form action="{{route('user.update',['user'=> $user])}}" method="POST" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" pjax-container="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select class="form-control roles select2 @error('role') is-invalid @enderror" style="width: 100%;" name="role" data-placeholder="Entrée Type Membre" data-value="12" tabindex="-1" aria-hidden="true">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        <input type="text" id="name" name="name" value="{{$user->name}}" class="form-control name @error('name') is-invalid @enderror" placeholder="Entrée Nom"> 
                    </div> 
                    @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        <input type="text" id="fonction" name="fonction" value="{{$user->fonction}}" class="form-control matricule @error('fonction') is-invalid @enderror" placeholder="Entrée Fonction">
                    </div>
                    @error('fonction')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
            ...
            <div class="form-group  ">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        <input type="text" id="telephone" name="telephone" value="{{$user->telephone}}" class="form-control phone @error('telephone') is-invalid @enderror" placeholder="Entrée Numero de telephone">
                    </div>
                    @error('telephone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
            ...
            <div class="form-group  ">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        <input type="date" id="date" name="date" value="{{$user->date}}" class="form-control date @error('date') is-invalid @enderror" placeholder="Entrée date"> 
                    </div>
                    @error('date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
