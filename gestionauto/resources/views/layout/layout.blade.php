    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="mission"><i class="fa fa-book"></i> Rédaction Mission</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-taxi"></i>Rédaction Course</a></li>
            <li><a href="coursse"><i class="fa fa-play"></i>Mission et Course en coure</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Maintenance</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
