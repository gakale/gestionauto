                ...
                <div class="box-body">
                    ...
                    <div class="fields-group">
                        ...
                        <div class="form-group   is-empty">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="montantreste" id="montantreste" name="montantreste" value="" class="form-control password_confirmation" placeholder="Entrée Montant resté">
                        ...
                        <div class="form-group   is-empty">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="montanttotal" id="montanttotal" name="montanttotal" value="" class="form-control password_confirmation" placeholder="Entrée Montant Total">
                        ...
                        <div class="form-group   is-empty">
                            ...
                            <label for="phone" class="col-sm-2  control-label">Lieu de Départ</label>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="phone" name="phone" value="" class="form-control phone" placeholder="Entrée le lieu de Départ">
                                ...
                                <div class="form-group   is-empty">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" id="heurretour" name="heurdepart" value="" class="form-control phone" placeholder="Entrée Heur de Retour">
                                ...
                                <div class="form-group   is-empty">
                                    ...
                                    <div class="form-group   is-empty">
                                        ...
                                        <div class="form-group   is-empty">
                                                ...
                                                <label for="carbuapresdepar" class="col-sm-2  control-label">Caburant Après Arrivé</label>
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="carbuapresdepar" name="carbuapresdepar" value="" class="form-control phone" placeholder="Entrée Caburant Après Arrivé">
                                            ...
                                            <div class="form-group   is-empty">
                                                ...
                                                <div class="form-group   is-empty">
                                                        ...
                                                        <label for="killoapresdepart" class="col-sm-2  control-label">Kilometrage Après Depart</label>
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="killoapresdepart" name="killoapresdepart" value="" class="form-control phone" placeholder="Entrée Caburant Après Arrivé">
